    ...
    <div className='absolute h-full w-full bg-black/40 z-50 flex justify-center items-center'>
        <div>
            <form action="" className='flex flex-col gap-y-2.5 bg-white w-[366px] p-7 rounded-xl shadow-md text-[14px]'>
                ...
                <input onChange={handlechange} value={formData.confirmPassword} type="text" name='confirmPassword' placeholder='Confirm Password' required  className='bg-[#f9f9f9] border-none p-2 pl-4 rounded-md outline-none' />
