            ...
            <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4">
              <h3 className="text-lg font-bold text-gray-900 mb-4">
                {modalType === 'addProperty' ? 'Add New Property' : 
                 modalType === 'editProperty' ? 'Edit Property' : 
                 modalType === 'viewProperty' ? 'Property Details' : 
              ...
              {modalType === 'addProperty' || modalType === 'editProperty' ? (
                ...
                <div className="space-y-3">
                  ...
                  <div><strong>Owner:</strong> {selectedItem.owner}</div>
                  <div><strong>Location:</strong> {selectedItem.location}</div>
                  <div><strong>Price:</strong> ₹{selectedItem.price?.toLocaleString()}/night</div>
                  <div><strong>Status:</strong> {selectedItem.status}</div>
                  <div><strong>Bookings:</strong> {selectedItem.bookings}</div>
                </div>
              ) : null}
              ...
              <div className="flex justify-end space-x-3 mt-6">
                ...
                {modalType !== 'viewProperty' && (
                  <button 
                    onClick={handleSave}
                    className="px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors"
                  >
                    {modalType === 'addProperty' ? 'Create Property' : 'Save Changes'}
                  </button>
                )}
              </div>
            </div>
